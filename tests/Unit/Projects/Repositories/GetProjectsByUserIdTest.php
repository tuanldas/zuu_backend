...
namespace Tests\Unit\Projects\Repositories;
...
class GetProjectsByUserIdTest extends TestCase
{
    ...
    function testCanGetProjects()
    {
        ...
        $projectRepository = $this->newProjectRepository();
        $response = $projectRepository->getProjectsByUserId($user->id);
    ...
    function testCannotGetProjectsWhenUidNotFound()
    {
        ...
        $projectRepository = $this->newProjectRepository();
        $response = $projectRepository->getProjectsByUserId('100');
